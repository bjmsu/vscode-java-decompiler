    ...
    private String getContent(ITypeLoader typeLoader, String path, IProgressMonitor monitor) throws CoreException {
        ...
        try {
            ...
            try {
                ...
                return new LineNumberFormatter(context, results.getLineNumberPositions()).reformatFile()+ " // Source code is unavailable, and was generated by the Procyon decompiler.\n"+stringWriter.toString();
            }
