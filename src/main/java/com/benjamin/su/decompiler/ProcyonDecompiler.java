...
public class ProcyonDecompiler extends CachingDecompiler {
    ...
    private String getContent(ITypeLoader typeLoader, String path, IProgressMonitor monitor) throws CoreException {
        ...
        try {
            ...
            writer.flush();
            writer.close();
            return new LineNumberFormatter(writer.toString(), results.getLineNumberPositions()).reformatFile()+ " // Source code is unavailable, and was generated by the Procyon decompiler.\n";
        } catch (Throwable t) {
